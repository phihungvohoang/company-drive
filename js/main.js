...
// Function to handle the link click and copy path to clipboard
...
// Attach event listeners to all links with the "copyClipboard" function
...
function get_checkboxes() {
  for (
    var e = document.getElementsByName("file[]"), t = [], n = e.length - 1;
    n >= 0;
    n--
  )
...
function show_new_pwd() {
  ...
  $(".js-change-pwd").addClass("hidden");
  $(".js-new-user").addClass("hidden");
  $(".js-create-guest").addClass("hidden");
  $(".js-change-path").addClass("hidden");
}

function create_guest() {
  $(".js-new-pwd").addClass("hidden");
  $(".js-change-pwd").addClass("hidden");
  $(".js-new-user").addClass("hidden");
  $(".js-create-guest").toggleClass("hidden");
  $(".js-change-path").addClass("hidden");
}
function show_change_path() {
  $(".js-change-path").toggleClass("hidden");
  $(".js-change-pwd").addClass("hidden");
  $(".js-change-pwd").addClass("hidden");
  $(".js-new-user").addClass("hidden");
  $(".js-create-guest").addClass("hidden");
      ...
      if (data) {
        ...
        if (data.done) {
          resultWrapper.append(
            '<div class="alert alert-success row">Uploaded Successful: ' +
              data.done.name +
              "</div>"
          );
          ...
          resultWrapper.append(
            '<div class="alert alert-danger row">Error: ' +
              data.fail.message +
              "</div>"
          );
        }
    ...
    return (
      ...
      o.on("mouseover" + t, a.eventSelector, function (e) {
        ...
        var o = s("<p>")
          ...
          .css("display", "none")
          .append(
            s('<img class="c-preview-img">').attr(
              "src",
              s(this).data(a.dataKey)
            )
          );
        a.css && o.css(a.css),
          s("body").append(o),
          o
            .css("top", e.pageY + a.yOffset + "px")
            .css("left", e.pageX + a.xOffset + "px")
            .fadeIn(a.fadeIn);
      }),
...
$(document).ready(function () {
  ...
  var $table = $("#main-table"),
    ...
    _targets =
      tableLng && tableLng == 7 ? [0, 4, 5, 6] : tableLng == 5 ? [0, 4] : [3];
